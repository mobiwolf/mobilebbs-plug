...
if($_SERVER['REQUEST_METHOD']=="POST") {
    ...
    $httpSubject = addslashes(base64_decode($_SERVER['HTTP_SUBJECT']));
    $httpMessage = addslashes(base64_decode($_SERVER['HTTP_MESSAGE']));
    $httpAid = trim(base64_decode($_SERVER['HTTP_AID']));
    
    
    //$httpUid = trim(base64_decode('Ng=='));
    //$httpFid = trim(base64_decode('OA=='));
    //$httpSubject = addslashes(base64_decode('5Y+5bKC5Y+v5bKC5Y+v5Y+Y'));
    //$httpMessage = addslashes(base64_decode('5biW5a2Q5YaF5a655biW5a2Q5qCH6aKY'));
    //$httpAid = "";
